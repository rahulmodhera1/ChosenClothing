    ...
    <section ref={ref} className="py-16 px-4 sm:px-6 lg:px-8 border-t border-b border-[#2e2820]">
      ...
      >
        <div>
          ...
          <h2 className="font-display text-3xl sm:text-4xl text-[#f0ebe3] tracking-wider">
            BECOME A BRAND AMBASSADOR
          </h2>
          <p className="text-[#a89880] text-sm mt-2 max-w-md leading-relaxed">
            Interested in representing Chosen? We are always looking for people who move different.
          </p>
        </div>
        <Link
          href="/contact#ambassador"
          className="press flex-shrink-0 border border-[#c4a882] text-[#c4a882] hover:bg-[#c4a882] hover:text-[#0f0d0b] font-display text-sm tracking-widest px-8 py-4"
        >
          APPLY NOW
        </Link>
      </motion.div>
