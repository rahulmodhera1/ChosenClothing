        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-4 mt-5">
              <a href="https://instagram.com/chosenofficialca" target="_blank" rel="noopener noreferrer" aria-label="Chosen on Instagram" className="text-[#5b6573] hover:text-[#14171c] transition-colors">
              ...
              <a href="https://x.com/chosen_ca" target="_blank" rel="noopener noreferrer" aria-label="Chosen on X" className="text-[#5b6573] hover:text-[#14171c] transition-colors">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
              </a>
              <a href="https://tiktok.com/@chosen_ca" target="_blank" rel="noopener noreferrer" aria-label="Chosen on TikTok" className="text-[#5b6573] hover:text-[#14171c] transition-colors">
