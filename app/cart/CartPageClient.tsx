        ...
        {lines.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                <div key={line.id} className="flex gap-5 pb-6 border-b border-[#2e2820]">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-start gap-4">
                      <div>
                        <h3 className="text-[#f0ebe3] font-medium text-sm leading-tight">
                      ...
                      <p className="text-[#c4a882] font-medium text-sm flex-shrink-0">
                        {formatPrice(
                    ...
                    <div className="flex items-center gap-4 mt-4">
                      <div className="flex items-center gap-2 border border-[#2e2820]">
                        <button
                          ...
                          disabled={isLoading}
                          className="press px-3 py-1.5 text-[#a89880] hover:text-[#f0ebe3] disabled:opacity-50"
                      ...
                      <button
                        ...
                        disabled={isLoading}
                        className="text-[#a89880] hover:text-red-400 transition-colors text-xs disabled:opacity-50"
                      >
                        Remove
                      </button>
                    </div>
            ...
            <div className="lg:sticky lg:top-24 lg:self-start bg-[#1a1714] border border-[#2e2820] p-6 space-y-4">
              ...
              <Link
                href="/shop"
                className="block w-full text-center text-[#a89880] hover:text-[#f0ebe3] text-xs transition-colors"
              >
                Continue shopping
              </Link>
            </div>
