...
export const mockProducts: Product[] = [
  ...
  // ── Washed Rhinestone Tracksuit ──────────────────────────────────────────
  {
    ...
    title: "Black Washed Rhinestone Tracksuit",
    handle: "rhinestone-tracksuit-set",
    description: "The full Black Washed Rhinestone Tracksuit. Oversized washed fleece with rhinestone Chosen logo. Unisex fit.",
    descriptionHtml: "<p>The full Black Washed Rhinestone Tracksuit. Oversized washed fleece with rhinestone Chosen logo. Unisex fit.</p>",
    featuredImage: { url: "/images/collections/Rhinestone/2.png", altText: "Black Washed Rhinestone Tracksuit", width: 800, height: 1000 },
    images: { nodes: [
      { url: "/images/collections/Rhinestone/2.png", altText: "Black Washed Rhinestone Tracksuit", width: 800, height: 1000 },
      { url: "/images/collections/Rhinestone/1.png", altText: "Black Washed Rhinestone Tracksuit styled", width: 800, height: 1000 },
    ]},
    priceRange: { minVariantPrice: { amount: "149.99", currencyCode: "CAD" }, maxVariantPrice: { amount: "149.99", currencyCode: "CAD" } },
    variants: { nodes: sizes(30, "149.99") },
    tags: ["rhinestone", "tracksuit", "set", "new-arrivals"],
    availableForSale: true,
  },
  {
    id: "gid://shopify/Product/5",
    title: "Black Washed Rhinestone Zip-Up",
    ...
    featuredImage: { url: "/images/collections/Rhinestone/3.png", altText: "Black Washed Rhinestone Zip-Up", width: 800, height: 1000 },
    images: { nodes: [
      { url: "/images/collections/Rhinestone/3.png", altText: "Black Washed Rhinestone Zip-Up", width: 800, height: 1000 },
      { url: "/images/collections/Rhinestone/RhinestoneZipup.png", altText: "Black Washed Rhinestone Zip-Up styled", width: 800, height: 1000 },
    ]},
    priceRange: { minVariantPrice: { amount: "89.99", currencyCode: "CAD" }, maxVariantPrice: { amount: "89.99", currencyCode: "CAD" } },
    variants: { nodes: sizes(40, "89.99") },
    tags: ["rhinestone", "hoodie"],
    availableForSale: true,
  },
  {
    id: "gid://shopify/Product/6",
    title: "Black Washed Rhinestone Pants",
    handle: "rhinestone-sweat-pants",
    description: "Washed fleece sweatpants with rhinestone Chosen logo on the leg. Pairs with the zip-up or worn alone.",
    descriptionHtml: "<p>Washed fleece sweatpants with rhinestone Chosen logo. Pairs with the zip-up or worn alone.</p>",
    featuredImage: { url: "/images/collections/Rhinestone/1.png", altText: "Black Washed Rhinestone Pants", width: 800, height: 1000 },
    images: { nodes: [
      { url: "/images/collections/Rhinestone/1.png", altText: "Black Washed Rhinestone Pants", width: 800, height: 1000 },
    ]},
    priceRange: { minVariantPrice: { amount: "79.99", currencyCode: "CAD" }, maxVariantPrice: { amount: "79.99", currencyCode: "CAD" } },
    variants: { nodes: sizes(50, "79.99") },
...
export const mockCollections: Collection[] = [
  ...
  },
  {
    ...
    description: "New arrivals. The Black Washed Rhinestone Tracksuit.",
    image: { url: "/images/collections/Rhinestone/2.png", altText: "Black Washed Rhinestone Tracksuit Collection", width: 1200, height: 800 },
